...
class CalendarFSVC: UIViewController {
...
//        calendar.today = nil // Hide the today circle
        calendar.register(CalendarFSCell.self, forCellReuseIdentifier: "cell")
...
extension CalendarFSVC : FSCalendarDataSource, FSCalendarDelegate, FSCalendarDelegateAppearance
{
...
//    }
    ...
    private func configure(cell: FSCalendarCell, for date: Date, at position: FSCalendarMonthPosition) {
        ...
        let diyCell = (cell as! CalendarFSCell)
        // Custom today circle
